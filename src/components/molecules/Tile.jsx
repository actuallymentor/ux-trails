...
export default function Tile( { icon: Icon, title, text, onClick, ...props } ) {
    return <TileContainer $display='flex' $direction='column' $padding="2rem" $justify="center" $align="center" onClick={ onClick } { ...props }>
        <Icon size="2rem" />
